...
" c
autocmd FileType c setlocal tabstop=4 shiftwidth=4 expandtab syntax=c.glib
...
augroup vimrc-javascript
  autocmd!
  autocmd FileType javascript set tabstop=4|set shiftwidth=4|set noexpandtab softtabstop=4
augroup END
